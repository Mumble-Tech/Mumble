  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="flex justify-center p-4">
        {!toggle && <Button onClick={handleClick} label="Join the waitlist" />}
        {toggle && (
          <div className="flex">
            <input
              type="text"
              placeholder="Enter email..."
              className="p-2 border-white rounded-lg"
            />
            <button
              className="ml-2 cursor-pointer bg-sky-100 hover:bg-sky-200 p-2 border rounded-lg"
        ...
        <a href="https://github.com/Mumble-Tech/Mumble">
          <Button label="Star on GitHub" img={true} />
        </a>
      </div>
      <SubHeading
